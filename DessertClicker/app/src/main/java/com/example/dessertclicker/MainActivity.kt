...
/*
* This function is like the second private fun DessertClickerApp
*
* */
@Composable
private fun DessertClickerApp(
    ...
    val uiState by viewModel.dessertClickerUiState.collectAsState()
    DessertClickerApp(
        uiState = uiState,
            ...
            DessertClickerAppBar(
                onShareButtonClicked = {
                    shareSoldDessertsInformation(
                        ...
                        revenue = uiState.revenue //change toi uiState
                    )
                },
                modifier = Modifier
                    .fillMaxWidth()
...
fun MyDessertClickerAppPreview() {
    DessertClickerTheme {
        // takes in a uistate and onDessertsClicked
        DessertClickerApp()
    }
}